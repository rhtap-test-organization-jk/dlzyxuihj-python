...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/dlzyxuihj-python-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-cmm5s.cmm5s.sandbox2518.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-cmm5s.cmm5s.sandbox2518.opentlc.com}
